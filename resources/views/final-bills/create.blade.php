...
<div class="container p-4 shadow rounded bg-light">
    <h2 class="mb-4">Create Final Bill</h2>
    
    <form action="{{ route('final-bills.store') }}" method="POST">
        @csrf
       <div class="row">
        ...
        <div class="col-md-4 col-sm-12 pb-3">
            <div class="form-group">
                ...
                <textarea name="service_details" class="form-control" placeholder="Enter Service Details" required></textarea>
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-success btn-lg mt-4">Generate Bill</button>
    </form>
</div>
